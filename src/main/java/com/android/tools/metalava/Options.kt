...
class Options(
    ...
    data class ConvertFile(
        ...
        val outputFormat: OutputFormat = OutputFormat.JDIFF
    )

    /** Output format to convert files to */
        ...
        while (index < args.size) {
            ...
            when (arg) {
                ...
                "-convert2xmlnostrip" -> {
                    ...
                    val format = when (arg) {
                        ARG_CONVERT_TO_V1 -> OutputFormat.V1
                        ARG_CONVERT_TO_V2 -> OutputFormat.V2
                        else -> OutputFormat.JDIFF
                    }
                ...
                "-new_api_no_strip" -> {
                    val format = when (arg) {
                        ARG_CONVERT_NEW_TO_V1 -> OutputFormat.V1
                        ARG_CONVERT_NEW_TO_V2 -> OutputFormat.V2
                        else -> OutputFormat.JDIFF
                    }
