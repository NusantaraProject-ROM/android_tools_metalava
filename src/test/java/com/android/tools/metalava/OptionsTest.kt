...
--output-default-values[=yes|no]         Controls whether default values should be
                                         included in signature files. The default is yes.
...
--doc-stubs <dir>                        Generate documentation stub source files for the
                                         ...
                                         list this as @NonNull. Another difference is that
                                         @doconly elements are included in documentation
...
--check-compatibility:type:state <file>  Check compatibility. Type is one of 'api' and
                                         ...
                                         API, respectively. Different compatibility checks
                                         apply in the two scenarios. For example, to check
                                         the code base against the current public API, use
...
--annotation-coverage-of <paths>         One or more jars (separated by `:`) containing
                                         ...
                                         used APIs that are missing annotation metadata
...
--include-source-retention               If true, include source-retention annotations in
                                         ...
                                         files. Source retention annotations are extracted
                                         into the external annotations files instead.
